...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-099-0070"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-v1",
      "problem_contract_sha256": "0b299fa2f67a52baafa740aed8d1ba0e427540a2a28dd6dc55fc6edddc6ed1e6",
      "problem_id": "problem:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a",
      "route_id": "route:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-source-fidelity-01",
      "graph_id": "graph:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does there exist a mixing random tiling of the Euclidean plane whose law is invariant under rotations and translations, is stationary under a local clustering-and-rescaling operation, and has a spatial Markov property in which a tile does not reveal the tiling of its complement along its boundary?"
          },
          "statement_sha256": "7517aa15d352a70f68379fc4f6ea9924c38ac1bc41510290d4a1f0cbb3d51795"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-root",
      "route_id": "route:um-amr-099-0070-rotation-translation-scale-and-markov-ba4cfb2a-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "domain": {
      "description": "Source-native Probability problem. Mathematical objects and notation are exactly those explicitly present in the frozen source statement.",
      "objects": [
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-099-0070-c55cea85bf36",
        "url": "https://www.unsolvedmath.com/problems/AMR-099-0070"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
